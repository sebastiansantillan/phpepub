...
<container version="1.0" xmlns="urn:oasis:names:tc:opendocument:xmlns:container">
    ...
    private function generateNavigationDocument(array $chapters): string
    {
        ...
        $title = $dom->createElement('title', 'Tabla de Contenidos');
        ...
        $h1 = $dom->createElement('h1', 'Tabla de Contenidos');
        $nav->appendChild($h1);
        ...
        foreach ($chapters as $index => $chapter) {
            ...
            $a = $dom->createElement('a', htmlspecialchars($chapter->getTitle()));
            $a->setAttribute('href', 'Text/' . $chapter->getFilename());
            $li->appendChild($a);
        }
