...
try {
    ...
    // Book metadata
    $epub->setTitle('Book with Custom Styles')
         ->setAuthor('Creative Designer')
         ->setLanguage('en')
         ->setDescription('An example demonstrating the use of custom CSS styles in PHPEpub');
    ...
    $epub->addChapter(
        ...
        '<div class="capitulo-inicio">
            <h1>Introduction</h1>
            <p>This book demonstrates how to use custom CSS styles to create e-books with a professional and attractive design.</p>
            
            <div class="destacado">
                <p><strong>Important note:</strong> The CSS styles applied in this book are completely customizable and can be adapted to your specific needs.</p>
            </div>
        </div>'
    );
