...
echo "🚀 Example with PHP 8.3+ features\n\n";

try {
    $epub = new EpubBuilder();

    // Configuration using improved syntax
    $epub->setTitle('Modern PHP 8.3 Book')
         ->setAuthor('Sebastián Santillán')
         ->setLanguage('en')
         ->setDescription('Demonstration of modern PHP 8.3 features in PHPEpub');
